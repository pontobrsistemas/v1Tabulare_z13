<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vendaFiltro.aspx.cs" Inherits="operador_vendaFiltro" %>
                   ...
                   <tr>
                       ...
                       <td class="style3" style="text-align: left">
                           <asp:TextBox ID="txtdatDataInicial" runat="server" CssClass="textbox" 
                               ...
                               onkeypress="mascara(this,data)" onkeyup="mascara(this,data)" Width="90px"></asp:TextBox>
                       ...
                       <td class="style5" style="text-align: left">
                           <asp:TextBox ID="txtdatDataFinal" runat="server" CssClass="textbox" 
                               style="text-align: left" onkeydown="mascara(this,data)" onkeypress="mascara(this,data)" onkeyup="mascara(this,data)" Width="90px"></asp:TextBox>
                ...
                <div class="div_relatorio">
                    <asp:Label ID="lblRegistros" runat="server" CssClass="label_descricao" 
                        Text="| 0 registro(s) |"></asp:Label>
                                     ...
                                     <asp:GridView ID="grdDados" runat="server" AutoGenerateColumns="True" CssClass="grid"
                                    EnableModelValidation="True" Style="text-align: left"   DataKeyNames="Cód. Hist."
                                    OnRowDataBound="grdDados_RowDataBound" AllowPaging="True" 
                                    onpageindexchanging="grdDados_PageIndexChanging" PageSize="25">
