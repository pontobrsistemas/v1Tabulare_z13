...
public partial class operador_vendaFiltro : System.Web.UI.Page
{
    ...
    public DataTable GerarRelatorio()
    {
        ...
        try
        {
            ...
            // opção para selecionar todas as campanhas do operador
            string sIDCampanhas = "";
    ...
    protected void grdDados_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == System.Web.UI.WebControls.DataControlRowType.DataRow)
        {
            ...
            int iIDHistorico = Convert.ToInt32(grdDados.DataKeys[e.Row.RowIndex].Values[0].ToString());
