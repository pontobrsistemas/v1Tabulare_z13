<%@ page title="Tabulare CRM" language="C#" masterpagefile="~/MasterPage/supervisor.master" autoeventwireup="true" inherits="supervisor_Default, App_Web_scj44z0b" %>
        ...
        <div class="redm_h1 ">  
            ...
            <div class="box_dashboard">
                ...
                <fieldset class="fieldset_l_dashboard">
                    ...
                    <div id="contatos dos operadores" style="width: 925px; height: 200px;" />
                </fieldset>
                <fieldset class="fieldset_l_dashboard ">
                    <legend runat="server" id="legenda_vendas">venda(s) efetivadas hoje</legend>
                    <div id="Vendas" style="width: 925px; height: 200px;" />
                </fieldset>
                <br />
                <fieldset class="fieldset_l_dashboard ">
