<%@ page title="Tabulare CRM" language="C#" masterpagefile="~/MasterPage/supervisor.master" autoeventwireup="true" inherits="supervisor_venda, App_Web_scj44z0b" %>
                ...
                <table class="style1">
                    <tr align=left>
                        <td class="style7" align="left">
                            ...
                            <asp:Button ID="cmdSalvarTopo" runat="server" CssClass="botao" 
                                                OnClick="cmdSalvar_Click" Text="Salvar" />
                            &nbsp;<asp:Button ID="cmdVoltarTopo" runat="server" CssClass="botao" 
                                Text="Voltar" onclick="cmdVoltarTopo_Click" />
                        </td>
                    </tr>
                </table>
                        ...
                        <ContentTemplate>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="style6">
                                            ...
                                            <asp:Button ID="bTnBuscarCep" runat="server" CssClass="botao" Text="Pesquisar" OnClick="bTnBuscarCep_Click" />
                                        </td>
                                    </tr>
                                </table>
                                <table>
                                    ...
                                    <tr>
                                        <td style="text-align: right">
                                            <asp:Label ID="lblOperador" runat="server" CssClass="label" Text="Operador:" 
                                                ></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblOperador_valor" runat="server" CssClass="label_dadosvenda" 
                                                ></asp:Label>
                                        </td>
                                        <td style="text-align: right">
                                            <asp:Label ID="lblDataContato" runat="server" CssClass="label" 
                                                Text="Data/Hora Contato:" ></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblDataContato_valor" runat="server" CssClass="label_dadosvenda" 
                                                ></asp:Label>
                                        </td>
                                        <td>
                                            &nbsp;</td>
                            ...
                            <fieldset class="fieldset_atendimento" id="Fieldset1" runat="server">
                                ...
                                <table>
                                    <tr>
                                        <td class="td">
                                            <asp:Label ID="lblBackoffice" runat="server" CssClass="label" 
                                                Text="Backoffice:"></asp:Label>
                                        </td>
                                        <td class="td_control">
                                            <asp:Label ID="lblBackoffice_valor" runat="server" CssClass="label_dadosvenda"></asp:Label>
                                        </td>
                                        <td class="td" rowspan="2">
                                            <asp:Label ID="lblObservacao" runat="server" CssClass="label" 
                                                Text="Observação:"></asp:Label>
                                            <br />
                                        </td>
                                        <td class="td" rowspan="2">
                                            <asp:TextBox ID="txtObservacao" runat="server" CssClass="textbox" Height="50px" 
                                                Width="400px" TextMode="MultiLine"></asp:TextBox>
                                        </td>
                                    </tr>                                    
                                    <tr>
                                        <td class="td">
                                            <asp:Label ID="lblDataAuditoria" runat="server" CssClass="label" 
                                                Text="Data/Hora Auditoria:"></asp:Label>
                                        </td>
                                        <td class="td_control">
                                            <asp:Label ID="lblDataAuditoria_valor" runat="server" 
                                                CssClass="label_dadosvenda"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="td" rowspan="2">
                                            <asp:Label ID="lblStatus" runat="server" CssClass="label" 
                                                Text="Status da Auditoria:"></asp:Label>
                                        </td>
                                        ...
                                        <td class="td">
                                            <asp:Label ID="lblObsVenda" runat="server" CssClass="label" 
                                                Text="OBS Venda:" Visible="False"></asp:Label>
                                        </td>
                                        <td class="td" rowspan="2">
                                           
                                            <asp:TextBox ID="txtObsVenda" runat="server" CssClass="textbox" 
                                                Height="50px" TextMode="MultiLine" Visible="False" Width="400px"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td colspan="4" height="15">
                                            <br/>
                                            <asp:Button ID="cmdSalvarRodape" runat="server" CssClass="botao" 
                                                OnClick="cmdSalvar_Click" Text="Salvar" />
                                            &nbsp;<asp:Button ID="cmdVoltarRodape" runat="server" CssClass="botao" 
                                                OnClick="cmdVoltarTopo_Click" Text="Voltar" />
                                            &nbsp;<asp:Button ID="cmdMensagem" runat="server" CssClass="botao" 
