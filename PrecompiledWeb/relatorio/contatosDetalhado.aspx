<%@ page title="Tabulare CRM" language="C#" masterpagefile="~/MasterPage/supervisor.master" autoeventwireup="true" inherits="relatorio_contatosDetalhado, App_Web_wym5kje3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <Triggers>
        ...
        <ContentTemplate>
            <h1>
                Relatório Contatos Trabalhados (Detalhados)
            </h1>
                        ...
                        <tr>
                            <td class="style32">
                                <asp:GridView ID="dgDados" runat="server" AutoGenerateColumns="True" CssClass="grid"
                                    ...
                                    OnRowDataBound="dgDados_RowDataBound" AllowPaging="True" 
                                    onpageindexchanging="dgDados_PageIndexChanging" PageSize="100">
